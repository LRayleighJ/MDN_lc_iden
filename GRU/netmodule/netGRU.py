...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        pi1 = self.lsfm(self.opepi1(x1))
        pi2 = self.lsfm(self.opepi2(x2))
        pi3 = self.lsfm(self.opepi3(x3))
        pi4 = self.lsfm(self.opepi4(x4))
        ...
        sigma1 = torch.exp(self.opesigma1(x1))
        sigma2 = torch.exp(self.opesigma2(x2))
        sigma3 = torch.exp(self.opesigma3(x3))
        sigma4 = torch.exp(self.opesigma4(x4))
