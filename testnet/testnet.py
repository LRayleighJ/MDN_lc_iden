...
import netmodule.netMDN_ResNet_500 as lcnet
import datamodule.datahist as dhist

# initialize preload netparams
reload = 1
preload_Netmodel = "/home/zerui603/MDN_lc/testnet/netparams/resnet_params5004args.pkl"
...
for index_sample in range(test_size):
    ...
    time_ref = np.linspace(lc_time[0],lc_time[-1],500)
    lc_ref = dhist.lc_hist(lc_withnoi,lc_time,lc_sig,num=500)
