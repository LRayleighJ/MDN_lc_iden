...
# reload
reload = 0
preload_Netmodel = "net_params200sk6args.pkl"
...
rootdir = "/scratch/zerui603/KMTsimu_te/data_200/training/"
rootval = "/scratch/zerui603/KMTsimu_te/data_200/val/"


# Loading datas
trainingsdata = lcnet.Mydataset(n_lc=size_train,data_root=rootdir)
...
for epoch in range(n_epochs):
    ...
    for (i,data) in enumerate(trainset):
        ...
        optimizer.zero_grad()
        outpi1,outpi2,outpi3,outpi4,outpi5,outpi6,outmu1,outmu2,outmu3,outmu4,outmu5,outmu6,outsigma1,outsigma2,outsigma3,outsigma4,outsigma5,outsigma6 = network(inputs)
        loss = criterion(labels,outpi1,outpi2,outpi3,outpi4,outpi5,outpi6,outmu1,outmu2,outmu3,outmu4,outmu5,outmu6,outsigma1,outsigma2,outsigma3,outsigma4,outsigma5,outsigma6)
        loss.backward()
        optimizer.step()
    ...
    with torch.no_grad():
        for j,valdata in enumerate(valset):
            ...
            optimizer.zero_grad()
            valoutpi1,valoutpi2,valoutpi3,valoutpi4,valoutpi5,valoutpi6,valoutmu1,valoutmu2,valoutmu3,valoutmu4,valoutmu5,valoutmu6,valoutsigma1,valoutsigma2,valoutsigma3,valoutsigma4,valoutsigma5,valoutsigma6 = network(val_inputs)
            loss = criterion(val_labels,valoutpi1,valoutpi2,valoutpi3,valoutpi4,valoutpi5,valoutpi6,valoutmu1,valoutmu2,valoutmu3,valoutmu4,valoutmu5,valoutmu6,valoutsigma1,valoutsigma2,valoutsigma3,valoutsigma4,valoutsigma5,valoutsigma6)
            val_sam = val_sam + 1
    ...
    plt.figure()
    x = np.linspace(0,epoch,len(loss_figure))
